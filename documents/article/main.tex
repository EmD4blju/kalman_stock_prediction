...
\begin{quote}
    ...
    Model uczony na danych filtrowanych, pomimo braku przewagi względem modelu bazowego w realistycznym teście, osiągnął wysoką skuteczność (\(R^2=0.9543\)) w teście na danych odszumionych, co świadczy o zdolności do niemal perfekcyjnej ekstrakcji trendu.
...
\end{itemize}
Dla każdego modelu przeprowadzono 150 prób optymalizacji (ang. \textit{trials}), a najlepsze zestawy hiperparametrów zostały następnie wykorzystane w treningu modeli.
...
Oznacza to, że model był w stanie wyjaśnić ponad 95\% wariancji w odszumionych danych. 
