...
Model z filtrem Kalmana wykazuje podobne wyniki do pozostałych modeli, co świadczy, że filtracja nie przyniosła znaczącej przewagi w kontekście predykcji na zaszumionych danych.
...
Kluczowe jest jednak zwrócenie uwagi na rozkład błędów modelu Kalmana na danych oryginalnych (dół-prawo), który jest zbliżony do rozkładu modelu bazowego (góra-lewo) oraz modelu wzbogaconego (góra-prawo), co ponownie podkreśla ograniczoną zdolność do generalizacji na zaszumione dane.
...
Zamiast prognozować dokładną wartość ceny, model wytrenowany na odszumionym sygnale mógłby okazać się znacznie skuteczniejszy w zadaniach klasyfikacyjnych, takich jak przewidywanie rynkowego kierunku zmiany ceny.
