...
\end{itemize}
Cały proces ewaluacji również został zaimplementowany jako zautomatyzowany pipeline w ramach projektu Kedro, co zapewniło spójność i powtarzalność całego eksperymentu. 
