...
Ninejszy rozdział przedstawia wyniki przeprowadzonych eksperymentów wedle opisanej metodyki.
...
W teście na danych filtrowanych model osiągnął rewelacyjną skuteczność: błąd RMSE na poziomie zaledwie 1.9891 oraz współczynnik determinacji \(R^2\) wynoszący 0.9756. 
...
Wizualna ocena wyników na danych filtrowanych (rys. \ref{fig:kalman_filtered_predictions} i \ref{fig:kalman_filtered_error_distribution}) pokazuje bardzo bliskie dopasowanie przewidywanych cen do rzeczywistych wartości.
Histogram błędów ma wąski rozkład, co świadczy o niskiej wariancji błędów predykcji.
