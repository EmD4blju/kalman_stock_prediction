...
\end{itemize}
Rysunek \ref{fig:ste_sigmoid_comparison} przedstawia porównanie obu funkcji aktywacji.
...
\end{figure}
W zależności od zastosowanej funkcji aktywacji, neuron może wykazywać różne zachowania.
...
Drugim kluczowym parametrem jest obciążenie, czyli bias \( b \), który działa jako przesunięcie funkcji aktywacji wzdłuż osi poziomej.
W istocie umożliwia to dostosowanie momentu, w którym neuron zostaje aktywowany.
