...
\begin{enumerate}
    ...
    Pozostałe parametry filtru, dobrane empirycznie w celu optymalnego wygładzenia sygnału, przedstawiono poniżej:
    \begin{itemize}
...
Rezultaty zostały podzielone na trzy sekcje, z których każda odpowiada jednemu z porównywanych modeli: model bazowy, model wzbogacony oraz model z filtrem Kalmana.
Dla każdego modelu przedstawiono kluczowe metryki wydajności na zbiorze testowym, wizualizacje porównujące przewidywane ceny z rzeczywistymi wartościami, analizę błędów predykcji oraz krzywe uczenia.
Całość zamyka podrozdział zawierający zbiorcze porównanie i dyskusję nad uzyskanymi rezultatami.
...
Ilustracja (rys.\ref{fig:base_model_visuals}) zestawia porównanie przewidywanych cen z rzeczywistymi wartościami oraz rozkład błędów predykcji.
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{assets/base_actual_vs_predicted.png}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{assets/base_error_distribution.png}
    \end{minipage}
    \caption{Wizualizacja wyników modelu bazowego: porównanie cen (lewo) i rozkład błędów (prawo).}
    \label{fig:base_model_visuals}
\end{figure}

Krzywe uczenia (rys.\ref{fig:base_model_learning_curve}) pokazują spadek wartości funkcji straty (MSE) oraz wzrost funkcji zysku (\(R^2\)) zarówno na zbiorze treningowym, jak i walidacyjnym w miarę postępu treningu.
\begin{figure}[H]
    \centering
...
Wizualna ocena modelu (rys.\ref{fig:enhanced_model_visuals}) potwierdza wyniki metryk. 
Chociaż model nadal podąża za ogólnym trendem, jego prognozy wykazują większe odchylenia od wartości rzeczywistych. 
Histogram błędów pokazuje szerszy rozkład, co wskazuje na większą wariancję błędów predykcji.
\begin{figure}[H]
    \centering
    \begin{minipage}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{assets/enhanced_actual_vs_predicted.png}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{assets/enhanced_error_distribution.png}
    \end{minipage}
    \caption{Wizualizacja wyników modelu wzbogaconego: porównanie cen (lewo) i rozkład błędów (prawo).}
    \label{fig:enhanced_model_visuals}
\end{figure}
...
Wizualna ocena wyników na danych filtrowanych (rys.\ref{fig:kalman_filtered_visuals}) pokazuje bardzo bliskie dopasowanie przewidywanych cen do rzeczywistych wartości, a histogram błędów ma wąski rozkład, co świadczy o niskiej wariancji błędów predykcji i dobrej generalizacji modelu.

\begin{figure}[H]
    \centering
    \begin{minipage}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{assets/kalman_actual_vs_predicted_filtered.png}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{assets/kalman_error_distribution_filtered.png}
    \end{minipage}
    \caption{Wizualizacja wyników modelu z filtrem Kalmana na danych filtrowanych: porównanie cen (lewo) i rozkład błędów (prawo).}
    \label{fig:kalman_filtered_visuals}
\end{figure}
...
Ilustracja (rys.\ref{fig:kalman_original_visuals}) zestawia porównanie przewidywanych cen z rzeczywistymi wartościami oraz rozkład błędów predykcji na oryginalnych danych.
\begin{figure}[H]
    \centering
    \begin{minipage}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{assets/kalman_actual_vs_predicted_original.png}
    \end{minipage}\hfill
    \begin{minipage}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{assets/kalman_error_distribution_original.png}
    \end{minipage}
    \caption{Wizualizacja wyników modelu z filtrem Kalmana na danych oryginalnych: porównanie cen (lewo) i rozkład błędów (prawo).}
    \label{fig:kalman_original_visuals}
\end{figure}
