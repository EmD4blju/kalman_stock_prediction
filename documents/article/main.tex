...
% Dzięki temu LSTM są w stanie efektywnie uchwycić zarówno krótkoterminowe, jak i długoterminowe zależności w danych szeregów czasowych \cite{TODO_LSTM_for_time_series}.
