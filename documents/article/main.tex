...
Histogram błędów pokazuje, że większość predykcji mieści się w niewielkim zakresie od rzeczywistych wartości, co jest zgodne z uzyskanymi metrykami wydajności.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/base_actual_vs_predicted.png}
    \caption{Porównanie cen rzeczywistych i przewidywanych przez model bazowy.}
    \label{fig:base_model_predictions}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/base_error_distribution.png}
    \caption{Rozkład błędów predykcji (reszt) dla modelu bazowego.}
